...
case $MESON_FAMILY in
  8)
    PKG_VERSION="ae8d639"
    PKG_SHA256="76f5c4898beb3b898e8ec8b0c91bea73ab5aae1a8f0b217fdc7b112508c87f8b"
    PKG_URL="https://github.com/Leverex/$PKG_NAME/archive/$PKG_VERSION.tar.gz"
    ;;
  6)
...
makeinstall_target() {
  mkdir -p $SYSROOT_PREFIX/usr/include
    cp -a usr/include/* $SYSROOT_PREFIX/usr/include

  mkdir -p $SYSROOT_PREFIX/usr/lib
    cp -a usr/lib/libMali.so $SYSROOT_PREFIX/usr/lib
  ...
  mkdir -p $INSTALL/usr/lib
    cp -a usr/lib/libMali.so $INSTALL/usr/lib
